...
//	ADMIN_TOKEN_HEADER_NAME, API_ACCESS_KEY_HEADER_NAME
    private final static String ALLOW_HEADERS = StringUtils.joinWith(",", HttpHeaders.CONTENT_ENCODING,HttpHeaders.CONTENT_TYPE);
