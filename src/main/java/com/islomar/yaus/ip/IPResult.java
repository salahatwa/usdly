...
/**
 * This class is used to store the geolocation data that is returned by the
 * IP2Location class.
 * <p>
...
public class IPResult {
	...
	/**
	 * This method to get internet connection speed (DIAL) DIAL-UP,(DSL) DSL/CABLE
	 * or(COMP) COMPANY
	 *
	...
	/**
	 * This method to get the varying length number assigned to geographic areas for
	 * call between cities.
	 *
	...
	/**
	 * This method to get the special code to identify the nearest weather
	 * observation station.
	 *
